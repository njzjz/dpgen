...
def _main():
    ...
    if args.TASK == 'vasp':
        ...
        make_lammps(jdata, args.CONF, args.MAX_MILLER, static=False,
                    relax_box=args.relax_box, task_type=args.TASK)
    elif args.TASK == 'deepmd-static' or args.TASK == 'meam-static':
        args.TASK = args.TASK.replace('-static', '')
        make_lammps(jdata, args.CONF, args.MAX_MILLER, static=True,
                    relax_box=args.relax_box, task_type=args.TASK)
    else:
