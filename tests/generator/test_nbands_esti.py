...
class TestNBandsEsti(unittest.TestCase):
    def test_predict(self):
        ...
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.010000K'), 72)
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.020000K'), 83)
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.040000K'), 112)
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.080000K'), 195)
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.160000K'), 429)
        self.assertEqual(self.nbe.predict(
            'out_data_nbands_esti/md.240000K'), 732)
